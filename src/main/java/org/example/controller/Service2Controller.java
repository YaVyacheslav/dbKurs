...
import org.example.view.Service2View;
...
public class Service2Controller implements Observer {
    private final Services2 model;
    private final Service2View view;

    public Service2Controller(Services2 model, Service2View view) {
        this.model = model;
        this.view = view;
