...
public class UserProfileView {
    ...
    private final TableView<org.example.model.Order> ordersTable = new TableView<>();
    ...
    public UserProfileView(UserProfile model) {
        ...
        TableColumn<org.example.model.Order, String> colServiceName =
                new TableColumn<>("Услуга");
        colServiceName.setCellValueFactory(new PropertyValueFactory<>("serviceName"));

        TableColumn<org.example.model.Order, String> colBranchAddress =
                new TableColumn<>("Филиал");
        colBranchAddress.setCellValueFactory(new PropertyValueFactory<>("branchAddress"));

        TableColumn<org.example.model.Order, java.sql.Date> colDate =
                new TableColumn<>("Дата приёма");
        colDate.setCellValueFactory(new PropertyValueFactory<>("acceptanceDate"));

        TableColumn<org.example.model.Order, java.sql.Date> colReturn =
                new TableColumn<>("Дата возврата");
        colReturn.setCellValueFactory(new PropertyValueFactory<>("returnDate"));

        TableColumn<org.example.model.Order, Integer> colPrice =
                new TableColumn<>("Цена");
        colPrice.setCellValueFactory(new PropertyValueFactory<>("price"));

        TableColumn<org.example.model.Order, Integer> colDiscount =
                new TableColumn<>("Скидка");
        colDiscount.setCellValueFactory(new PropertyValueFactory<>("discount"));

        ordersTable.getColumns().addAll(
                colServiceName, colBranchAddress, colDate, colReturn,
    ...
    public TableView<org.example.model.Order> getOrdersTable() {
        return ordersTable;
    }
    ...
    public void setOrders(java.util.List<org.example.model.Order> list) {
